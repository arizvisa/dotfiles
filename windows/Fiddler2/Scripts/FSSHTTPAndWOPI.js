/**
  ...
  It adds a column that can be used to identify the SharePoint WOPI request type.
*/
...
function CalcMethodCol(oS : Session) {
    ...
    if (oS != null && (oS.fullUrl.ToLower().Contains("/_vti_bin/wopi.ashx")) || oS.fullUrl.ToLower().EndsWith("hosting/discovery")) {
        isWOPI = true;    } else if (oS != null && oS.RequestHeaders["SOAPAction"] == "\"http://schemas.microsoft.com/sharepoint/soap/ICellStorages/ExecuteCellStorageRequest\"") {
        isFSSHTTP = true;    } else {
        return "";
    }
    var op: String = null;
